...
const objLat = (obj) => {
    // write yourv code here
    let name0 = obj.firstName.charAt(0).toUpperCase()
    let name = obj.firstName.slice(1);
    let name1 = name0 + name;
    let name00 = obj.lastName.charAt(0).toUpperCase()
    let name11 = obj.lastName.slice(1);
    let name2 = name00+ name11
    
   
    return (`my name is ${name1} ${name2} I am ${obj.age} YO, and I love ${obj.hobby}.`);
};
